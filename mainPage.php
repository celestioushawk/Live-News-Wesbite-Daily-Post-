...
$url = 'https://newsapi.org/v2/top-headlines?country=in&apiKey=<--API KEY HERE-->';
$data = file_get_contents($url);
$news_array = json_decode($data, true);
if($news_array['totalResults'] == 0)
{
...
<footer>
	<center>
		2020 The Daily Post Inc. ( made with ❤️ by Piyush Tekwani)
	</center>
</footer>
