This is a live news website that I have created using the NewsAPI.org API with using PHP as the backend and HTML/CSS as the front-end. I learned a lot of things while working on this project, such as:
